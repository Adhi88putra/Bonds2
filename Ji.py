...
#ki = LineClient()
ki = LineClient(authToken='Ey4d6OS2MIYhVee6x4g9.nuUU5kRRG+fC3Z9YVNv7Qq.tt9jabKe1aqrYJp/EADdWg+EsXLM2hBmWChwjJRaUz4=')
ki.log("Auth Token : " + str(ki.authToken))
channel1 = LineChannel(ki)
ki.log("Channel Access Token : " + str(channel1.channelAccessToken))

#kk = LineClient()
kk = LineClient(authToken='EypTpgrdo1wxBmkD1pa2.buJLD7JrrngDnMf5qDfqyG.vDVBZFMvQfFXPlvGA5owWk5uk1if+Xh6ajAh0ppb8cA=')
kk.log("Auth Token : " + str(kk.authToken))
channel2 = LineChannel(kk)
kk.log("Channel Access Token : " + str(channel2.channelAccessToken))

#kc = LineClient()
kc = LineClient(authToken='EyFF9dKPJ3EXNSUAIsOf.9eQsWmyR4F9AFNPZDyQTtW.kSyEFQOBhcnu70MUWwTmo71fPHFEc51CIionHEoNiSQ=')
kc.log("Auth Token : " + str(kc.authToken))
channel3 = LineChannel(kc)
kc.log("Channel Access Token : " + str(channel3.channelAccessToken))

#sw = LineClient()
sw = LineClient(authToken='Ey7t8WjDhC4aZIcU0F83.TrVjFf5pyd8D+ZxPusvq0W.fjTj8+m3fvFWVCpKwEddTouD/m1IsAMZECHjKQIuTKI=')
...
poll = LinePoll(cl)
call = cl
creator = ["u25513b48dd877db73b78b8b754a6d43d"]
owner = ["u25513b48dd877db73b78b8b754a6d43d"]
admin = ["u25513b48dd877db73b78b8b754a6d43d"]
staff = ["u25513b48dd877db73b78b8b754a6d43d"]
...
wait = {
    ...
    "Respontag":"Jangan NgeTag Aku Sayang Nti Anu Lho",
